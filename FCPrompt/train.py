...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.PLOT.CTX_INIT = "a photo of a"  # initialization words
    ...
    cfg.TRAINER.PLOT.DEPTH = 12
    cfg.TRAINER.PLOT.V_CTX = 4
    cfg.TRAINER.PLOT.SELECTED = 32
    cfg.OPTIM.RHO = 0.1
